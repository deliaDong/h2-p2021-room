...
class RoomStudent {
  ...
  initGeometry() {
    ...
    this._g.roofLight = new THREE.BoxBufferGeometry(0.6, 0.3, 0.05)
    this._g.door = new THREE.BoxBufferGeometry(1.2, 2.2, 0.1)
    this._g.doorH = new THREE.BoxBufferGeometry(0.2, 0.1, 0.05)

    // Bed
    this._g.bedB = new THREE.BoxBufferGeometry(1.9, 0.25, 2.3)
    this._g.bedT = new THREE.BoxBufferGeometry(2, 0.1, 2.4)
    this._g.bedM1 = new THREE.BoxBufferGeometry(1.8, 0.2, 2.2)
    this._g.bedM2 = new THREE.BoxBufferGeometry(1.9125, 0.25, 1.8)
    ...
    this._g.picture = new THREE.BoxBufferGeometry(0.2, 0.25, 0.05)
    this._g.pictureH = new THREE.BoxBufferGeometry(0.05, 0.15, 0.05)
    this._g.pictureF = new THREE.PlaneBufferGeometry(0.15, 0.2, 1, 1)

    // Wardrobe
    this._g.wardrobeL = new THREE.BoxBufferGeometry(0.6, 1.1, 1.5)
    this._g.wardrobeLD = new THREE.BoxBufferGeometry(0.1, 0.45, 1.4)
    this._g.wardrobeLH = new THREE.BoxBufferGeometry(0.1, 0.05, 0.2)
    this._g.wardrobeR = new THREE.BoxBufferGeometry(0.6, 2.2, 0.1)
    this._g.wardrobeRH = new THREE.BoxBufferGeometry(0.55, 0.05, 1.3)
    this._g.wardrobeRR = new THREE.BoxBufferGeometry(0.05, 0.05, 1.3)
    this._g.wardrobeRT = new THREE.BoxBufferGeometry(0.6, 0.1, 1.3)
    this._g.wardrobeRC1 = new THREE.BoxBufferGeometry(0.3, 1, 0.05)
    this._g.wardrobeRC2 = new THREE.BoxBufferGeometry(0.4, 0.8, 0.05)
    this._g.wardrobeRC3 = new THREE.BoxBufferGeometry(0.5, 0.6, 0.05)
    this._g.torusKnot = new THREE.TorusKnotBufferGeometry(0.075, 0.02, 32, 12)

    // Desk
    this._g.deskL = new THREE.CylinderBufferGeometry(0.05, 0.05, 0.9, 5)
    this._g.deskT = new THREE.BoxBufferGeometry(2, 0.05, 0.8)
    this._g.screenB = new THREE.BoxBufferGeometry(0.2, 0.05, 0.1)
    this._g.screenP = new THREE.BoxBufferGeometry(0.05, 0.2, 0.05)
    this._g.screen = new THREE.BoxBufferGeometry(0.6, 0.35, 0.05)
    this._g.screenF = new THREE.PlaneBufferGeometry(0.55, 0.3, 1, 1)
    this._g.keyboard = new THREE.BoxBufferGeometry(0.575, 0.05, 0.2)
    this._g.keyboardK1 = new THREE.BoxBufferGeometry(0.35, 0.05, 0.15)
    this._g.keyboardK2 = new THREE.BoxBufferGeometry(0.15, 0.05, 0.15)
    this._g.mouse = new THREE.BoxBufferGeometry(0.075, 0.05, 0.1)
    this._g.case = new THREE.BoxBufferGeometry(0.3, 0.6, 0.7)

    // Chair
    this._g.chairL = new THREE.BoxBufferGeometry(0.7, 0.05, 0.05)
    this._g.chairW = new THREE.CylinderBufferGeometry(0.05, 0.05, 0.05, 7)
    this._g.chairP = new THREE.CylinderBufferGeometry(0.04, 0.04, 0.35, 5)
    this._g.chairB = new THREE.BoxBufferGeometry(0.5, 0.15, 0.5)
    this._g.chairBAlt = new THREE.BoxBufferGeometry(0.5, 0.15, 0.3)
    this._g.chairF = new THREE.BoxBufferGeometry(0.5, 0.1, 0.1)

    // Canvas
    this._g.canvas = new THREE.BoxBufferGeometry(0.05, 1, 1.8)
  ...
  createCanvasShape () {
    ...
    for (let i = 0; i < 50; i++) {
      const geometry = new THREE.PlaneBufferGeometry(0.1 + Math.random() * 0.1, 0.2 + Math.random() * 0.4, 1, 1)
